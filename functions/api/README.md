***REMOVED***📚 Cloudflare Workers API Functions Reference
...
#***REMOVED***2. RPC 유틸리티 (rpc-utils.ts)

##***REMOVED***2.1 AnkrRpc 클래스
...
###***REMOVED***2.1.1 sendBoc(boc: string): Promise<string>
...
###***REMOVED***2.1.2 getAccountState(address: string): Promise<any>
...
###***REMOVED***2.1.3 getSeqno(address: string): Promise<number>
...
###***REMOVED***2.1.4 getBalance(address: string): Promise<bigint>
...
###***REMOVED***2.1.5 runGetMethod(address, method, params): Promise<any>
...
###***REMOVED***2.2.1 getAndIncrementSeqno(): Promise<number>
...
###***REMOVED***2.2.2 resetSeqno(): Promise<void>
...
#***REMOVED***3. 입금 API (initiate-deposit.ts)
...
#***REMOVED***4. 인출 API (initiate-withdrawal.ts)

##***REMOVED***4.1 개요 (v2.1 개선)
...
###***REMOVED***buildJettonTransferPayload()
...
#***REMOVED***5. 디버그 API (debug-withdrawal.ts)
...
***REMOVED***민감한 정보는 여기 설정 금지!
***REMOVED***대신 Cloudflare 대시보드에서 설정
```
