...
#***REMOVED***1. TON 관련 라이브러리 목록

##***REMOVED***1.1 프론트엔드 (Frontend) 라이브러리
...
##***REMOVED***2.2 Jetton Wallet 주소 파생
...
#***REMOVED***3. RPC 통신 아키텍처

##***REMOVED***3.1 RPC Wrapper 함수
...
#***REMOVED***4. 트랜잭션 생성 방식

##***REMOVED***4.1 프론트엔드 트랜잭션 생성
...
```bash
npm run dev  ***REMOVED***Vite 개발 서버 시작
```
