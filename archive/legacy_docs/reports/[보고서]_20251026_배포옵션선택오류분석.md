...
##***REMOVED*****deployWithdrawalManager.ts의 버그**
...
##***REMOVED*****Option 1: 스크립트 수정 후 재배포**

```bash
***REMOVED***deployWithdrawalManager.ts 수정
***REMOVED***라인 22-23:
...
***REMOVED***2. 네트워크: testnet 선택
***REMOVED***3. 지갑: TON Connect compatible mobile wallet (example: Tonkeeper) 선택
***REMOVED***4. 지갑: Tonkeeper 선택
***REMOVED***5. QR 코드 스캔 및 승인
```
