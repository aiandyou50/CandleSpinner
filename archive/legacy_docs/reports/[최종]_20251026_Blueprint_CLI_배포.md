...
$privateKey = "***REDACTED-TON-PRIVATE-KEY***"
...
```powershell
cd c:\Users\x0051\Desktop\DEV\CandleSpinner\contracts && npm run build && npx blueprint deploy --privkey "***REDACTED-TON-PRIVATE-KEY***" --testnet
```
