...
#***REMOVED***🚀 **핵심 기능 (v2.1.0)**

##***REMOVED***1️⃣ **입금 방식 선택 화면** (웹 모드)
```
게임 → [입금] → [방식 선택]
                ├─ 🔑 TonConnect 입금 (권장)
                │   ✅ 지갑에서 직접 서명
...
##***REMOVED***2️⃣ **A/B 테스트 데이터 수집**
- 각 방식별 성공률
- 실패율 및 오류 분석
- 사용자 경험 피드백
- v2.2.0에서 최적 방식 결정

##***REMOVED***3️⃣ **환경변수 구조 정비**
```toml
[vars]
