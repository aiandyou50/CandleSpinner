***REMOVED***🚨 긴급: 인출 500 오류 근본 원인 및 해결책
...
##***REMOVED***debug-withdrawal API 응답 분석
...
##***REMOVED***Step 1: wrangler.toml 수정 (완료)
...
##***REMOVED***Step 2: Cloudflare 대시보드에서 실제 값 설정
...
##***REMOVED***Step 3: Cloudflare Pages 설정
...
**또는 CLI로:**
```bash
***REMOVED***wrangler secret set (프로덕션 배포)
...
##***REMOVED***왜 wrangler.toml에 선언해야 하나?
...
##***REMOVED***만약 GAME_WALLET_ADDRESS/CSPIN_TOKEN_ADDRESS를 잃어버렸다면?
