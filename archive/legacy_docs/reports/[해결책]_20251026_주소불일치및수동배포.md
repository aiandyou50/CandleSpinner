...
***REMOVED***3. 배포 정보 확인
node deploy-cli.mjs "***REDACTED-TON-PRIVATE-KEY-ROTATE-IMMEDIATELY***" testnet

***REMOVED***4. Blueprint로 배포
npx blueprint deploy --privkey "***REDACTED-TON-PRIVATE-KEY-ROTATE-IMMEDIATELY***" --testnet
```
