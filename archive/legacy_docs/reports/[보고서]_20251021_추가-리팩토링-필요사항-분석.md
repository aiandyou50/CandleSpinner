***REMOVED***[보고서]_20251021_추가-리팩토링-필요사항-분석
...
#***REMOVED***1️⃣ **Cloudflare wrangler.toml 경고 이슈**
...
***REMOVED***TON_RPC_API_KEY, TON_RPC_HTTPS_ENDPOINT도 추가
```
...
#***REMOVED***2️⃣ **Transaction Fee 정책 부재**
...
#***REMOVED***3️⃣ **TonConnect 버튼 가시성 이슈**

##***REMOVED***현재 상태 (App.tsx)
```typescript
...
[vars]
BACKEND_RPC_URL = "https://toncenter.com/api/v2/jsonRPC"
TON_RPC_HTTPS_ENDPOINT = "https://mainnet-v4.akka.tonwhales.com"  ***REMOVED***또는 ankr
