***REMOVED***명령 지시서: MVP 전체 리팩토링 및 재구축
...
##***REMOVED***Phase 4: 문서 동기화
- [산출물2]: Ankr RPC 및 이중 입금 방식 아키텍처 추가
- [산출물3]: A/B 의사코드 모두 기록

##***REMOVED***Phase 5: 테스트 & 배포
- A방식 테스트 (가장 안정적)
