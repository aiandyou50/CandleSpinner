***REMOVED***명령 지시서: Phase 3-2 중복 코드 제거 및 커스텀 Hooks 추출
...
#***REMOVED***🎯 식별된 중복 코드 & 해결책

##***REMOVED***1. Telegram WebApp 초기화 중복
