***REMOVED***[해결 기록] RPC 인출 방식 TonCenter v3 API로 변경
...
##***REMOVED***Step 1: SSOT 문서 업데이트 (3개)

###***REMOVED***`docs/ssot/[산출물2]기술-스택-및-아키텍처-설계.md`
**변경 내용:**
- 버전 2.2.0 → 2.3.0
...
###***REMOVED***`docs/ssot/[산출물3]MVP핵심-로직-의사코드.md`
**변경 내용:**
...
##***REMOVED***Step 2: 코드 수정

###***REMOVED***`functions/api/rpc-utils.ts` (+~230줄)
**추가 내용:**
...
###***REMOVED***`functions/api/initiate-withdrawal.ts` (~10개 변경)
**변경 내용:**
...
###***REMOVED***`wrangler.toml` (2개 섹션 수정)
**변경 내용:**
