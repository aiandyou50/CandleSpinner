***REMOVED***📚 SSOT (Single Source of Truth) - 완전 가이드
...
##***REMOVED***1️⃣ **README.md** (메인 SSOT 문서) ⭐
...
##***REMOVED***2️⃣ **[산출물 1] 프로젝트 정의서** (v2.0)
...
##***REMOVED***3️⃣ **[산출물 2] 기술 스택 및 아키텍처** (v2.2.0)
...
##***REMOVED***4️⃣ **[산출물 3] MVP 핵심 로직 의사코드** (v2.1.0)
...
##***REMOVED***5️⃣ **[산출물 4] TMA 하이브리드 변환** (v2.0)
