***REMOVED***퀵-AI워크플로워-지침서 (AI Bootstrap Prompt) [v3.1 - Lite 워크플로우]
...
#***REMOVED*****Lite 워크플로우 vs Full 워크플로우 선택 가이드**

##***REMOVED*****Lite 워크플로우 사용 (현재 가이드)**
- 📝 **문서만 수정할 때** → Lite
- 🐛 **버그 수정** (코드 1-3줄) → Lite
- ⚡ **빠른 반복** 필요 → Lite
- 🔍 **리팩토링** (기능 변경 없음) → Lite
...
#***REMOVED*****[Lite 워크플로우] 4단계**

##***REMOVED*****[Step 1] 요청 분석 (빠르게) + 🔐 보안 검증 (필수)**
```
