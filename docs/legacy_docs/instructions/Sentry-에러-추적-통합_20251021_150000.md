***REMOVED***Sentry 에러 추적 통합 지시서
#***REMOVED***목표: 프로덕션 에러 모니터링 시스템 구축
...
##***REMOVED***1. Sentry SDK 설치
```bash
npm install --save @sentry/react @sentry/tracing
```

##***REMOVED***2. 주요 코드 변경사항

###***REMOVED***`src/main.tsx` - Sentry 초기화
```typescript
...
###***REMOVED***`src/components/ErrorBoundary.tsx` - 새로 생성
```typescript
...
###***REMOVED***`src/App.tsx` - ErrorBoundary 적용
```typescript
<ErrorBoundary>
...
#***REMOVED***🚀 다음 단계 (Phase 1 계속)

##***REMOVED***3️⃣ Rate Limiting 적용
