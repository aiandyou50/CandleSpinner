***REMOVED***명령 지시서: Phase 2-4 성능 모니터링 (Sentry Web Vitals)
...
##***REMOVED***1. Sentry Performance Monitoring 설정
**파일**: `src/main.tsx`
