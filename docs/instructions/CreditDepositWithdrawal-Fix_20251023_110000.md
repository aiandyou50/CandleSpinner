***REMOVED***명령 지시서: 크레딧 입금/인출 로직 완전 수정
...
##***REMOVED***Issue 1: 입금 후 크레딧이 증가하지 않음
...
##***REMOVED***Issue 2: 인출 버튼이 API를 호출하지 않음
