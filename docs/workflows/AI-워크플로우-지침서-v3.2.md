***REMOVED***🤖 AI 워크플로우 지침서 v3.2 (Priority 기반)
...
#***REMOVED***📊 Priority 기반 워크플로우

##***REMOVED***Priority A: 아키텍처/API 변경 (Full 워크플로우)
...
##***REMOVED***Priority B: 기능 추가/버그 수정 (Mid 워크플로우)
...
##***REMOVED***Priority C: 문서 수정/리팩토링 (Light 워크플로우)
...
##***REMOVED***Q1: Priority를 잘못 판단하면?
**A:** 괜찮습니다. 대부분 맞을 것이고, 틀려도 사용자가 지적하면 수정하면 됩니다.

##***REMOVED***Q2: 기존 6단계 Full 워크플로우는?
**A:** 레거시에 보관됨. `docs/레거시/workflows/` 참조 (Reference용)

##***REMOVED***Q3: CHANGELOG.md는 어떻게?
**A:**
