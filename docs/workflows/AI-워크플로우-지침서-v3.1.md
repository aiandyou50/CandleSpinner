...
#***REMOVED*****2. 문서 저장소 구조 (Repository Structure) [v3.1 개선]**
...
#***REMOVED*****3. 버전 관리 정책 (Versioning Policy)**

##***REMOVED*****3.1 시맨틱 버전(SemVer) 준수**
- 프로젝트는 `Major.Minor.Patch` (예: `1.0.0`) 형식의 SemVer를 엄격히 준수합니다.

##***REMOVED*****3.2 마스터 버전 관리**
...
#***REMOVED*****5. 핵심 워크플로우 (Core Workflow) [v3.1: Lite/Full 하이브리드]**

##***REMOVED*****5-A. Lite 워크플로우 (빠른 개발용) [v3.1 신규]**
...
##***REMOVED*****5-B. Full 워크플로우 (공식 릴리즈용)**
...
#***REMOVED*****6. 세션 시작 규칙 (Session Start Rule) [v3.1 개선]**

##***REMOVED*****6.1 새 세션 시작 프로세스**
...
#***REMOVED*****7. Quick Reference (빠른 선택 가이드)**
