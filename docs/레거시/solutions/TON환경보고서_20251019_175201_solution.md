***REMOVED***해결 기록: TON 블록체인 개발 환경 보고서 작성
...
##***REMOVED***4.2 Private Key 없음

백엔드는 Private Key를 가지지 않으므로:
- 직접 온체인 트랜잭션 전송 불가
- 인출 처리는 별도 보안 서버 필요

##***REMOVED***4.3 환경 변수 의존성
