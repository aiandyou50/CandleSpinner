***REMOVED***해결 기록: TonConnect 버튼 표시 및 입금 오류 수정
...
###***REMOVED*****Deposit.tsx - Jetton Transfer Payload 함수**
...
###***REMOVED*****App.tsx - TMA 환경 TonConnect 버튼**
