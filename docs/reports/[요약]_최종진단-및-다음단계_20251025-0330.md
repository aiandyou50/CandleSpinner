***REMOVED***최종 진단 및 다음 단계 (2025-10-25 오전)
...
##***REMOVED***1️⃣ **중앙화 방식 - Jetton 주소 재확인** (5분) ⏰
...
##***REMOVED***2️⃣ **RPC 방식 - Ankr Origin 확인** (5분) ⏰
...
##***REMOVED***3️⃣ **RPC 재테스트** (Ankr 확인 후)
...
#***REMOVED***🔧 추가 정보가 필요할 때

##***REMOVED***중앙화 방식이 여전히 실패하면
