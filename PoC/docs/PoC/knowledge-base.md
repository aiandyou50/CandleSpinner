...
##***REMOVED***Q: 트랜잭션 전송 시 필요한 파라미터는 무엇인가요?
...
##***REMOVED***Q: boc를 base64로 변환하는 방법은?
...
##***REMOVED***Q: "Transaction verification failed" 오류가 발생합니다
A: 다음을 확인하세요:
...
##***REMOVED***Q: 커스텀 페이로드가 있는 제톤 전송은 어떻게 하나요?
