...
\***REMOVED***1. 개요 (Overview)



\#***REMOVED***1.1. 프로젝트 명칭 (Project Name)  

\*\*CandleSpinner: The Galactic Casino\*\*



\#***REMOVED***1.2. 프로젝트 목표 (Project Goal)  
...
\***REMOVED***2. 🚨 현재 진행 중인 작업 (Active Issues - AI START HERE)



\#***REMOVED***2.4. Newly reported issues (Pending triage)
...
\***REMOVED***3. 기능 요구사항 (Functional Requirements)
...
\#***REMOVED***3.1. 사용자 인터페이스 (User Interface)



\##***REMOVED***\[FR-UI-01] 뷰 상태 관리 (View State Management)  
...
\##***REMOVED***\[FR-UI-02] 지갑 연결 (Wallet Connection)  
...
\##***REMOVED***\[FR-UI-03] 다국어 지원 (Multi-language Support)  
...
\##***REMOVED***\[FR-UI-04] 버전 정보 표시 (Version Display)  
...
\##***REMOVED***\[FR-UI-05] 지갑 정보 표시 및 연결 해제  
...
\#***REMOVED***3.2. 게임 플레이 (Game Play)



\##***REMOVED***\[FR-GAME-01] 슬롯머신  
...
\##***REMOVED***\[FR-GAME-05] 실제 토큰 상금 지급  
...
\##***REMOVED***\[FR-GAME-06] 더블업 미니게임 개선  
...
\#***REMOVED***3.3. 개발 및 테스트



\##***REMOVED***\[FR-DEV-01] 개발자 모드 (결과 강제)  
...
\##***REMOVED***\[FR-DEV-02] 개발자 모드 (무료 플레이)  
...
\##***REMOVED***\[FR-DEV-03] 개발자 모드 BOC 로깅  
...
\***REMOVED***4. 비기능 요구사항 (Non-Functional Requirements)
...
\***REMOVED***5. 완료된 버그 아카이브 (Resolved Issues Archive)
