***REMOVED***🚀 백엔드 직접 전송 방식 - 빠른 시작 가이드
...
#***REMOVED***🌐 4단계: 프론트엔드 테스트

##***REMOVED***방법 1: 간단한 HTTP 서버

```powershell
***REMOVED***frontend-poc 폴더에서
npx http-server -p 8080 --cors
```

##***REMOVED***방법 2: 기존 스크립트 수정
...
***REMOVED***프론트엔드 시작 (direct-transfer.html로 변경)
...
##***REMOVED***오류: "Owner Jetton Wallet not found"
- **원인**: Jetton Master 주소 오류
- **해결**: `.env`에서 `JETTON_MASTER` 확인

##***REMOVED***오류: "Insufficient balance"
- **원인**: Owner Jetton Wallet 잔고 부족
- **해결**: 게임 지갑에서 CSPIN 충전

##***REMOVED***오류: "Transaction failed"
- **원인**: 가스비 부족
