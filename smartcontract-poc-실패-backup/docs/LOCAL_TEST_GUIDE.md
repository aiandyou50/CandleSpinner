...
**터미널 1 (PowerShell)**
```powershell
***REMOVED***backend-api 폴더로 이동
cd C:\Users\x0051\Desktop\DEV\contracts\backend-api

***REMOVED***의존성 설치 (최초 1회만)
npm install

***REMOVED***.env 파일 생성 (최초 1회만)
***REMOVED***메모장으로 .env 파일 생성하고 아래 내용 입력:
***REMOVED***OWNER_MNEMONIC=tornado run casual carbon ...
***REMOVED***PORT=3000
...
##***REMOVED***Step 2: 프론트엔드 서버 실행

**터미널 2 (PowerShell) - 새 터미널 열기**
```powershell
***REMOVED***frontend-poc 폴더로 이동
cd C:\Users\x0051\Desktop\DEV\contracts\frontend-poc

***REMOVED***Python HTTP 서버 실행 (Python 3)
python -m http.server 8080

***REMOVED***또는 Node.js가 있다면
...
```powershell
***REMOVED***포트 변경
***REMOVED***.env 파일에서 PORT=3001로 변경
***REMOVED***index.html의 BACKEND_URLS도 3001로 변경
```

##***REMOVED***프론트엔드 서버가 시작되지 않음
...
***REMOVED***브라우저에서 http://localhost:8081 접속
```
