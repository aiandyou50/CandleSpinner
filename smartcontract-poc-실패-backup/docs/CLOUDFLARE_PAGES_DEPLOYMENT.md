***REMOVED***Cloudflare Pages 서버리스 배포 가이드

#***REMOVED***⚠️ 중요: Cloudflare Pages 제한사항

##***REMOVED***백엔드 API를 Cloudflare Pages로 배포 불가능 ❌
...
##***REMOVED***Option 1: Cloudflare Pages + Cloudflare Workers ⭐ (추천)
...
##***REMOVED***Option 2: Cloudflare Pages + 외부 백엔드 🚀 (가장 쉬움)
...
##***REMOVED***1단계: 프론트엔드 (Cloudflare Pages)
...
**배포:**
```bash
***REMOVED***Git push만 하면 자동 배포
git push origin main
```

##***REMOVED***2단계: 백엔드 (Render.com 무료)
...
##***REMOVED***backend-api/server.js (이미 수정됨 ✅)
```javascript
...
#***REMOVED***📦 Render.com 배포 (무료 백엔드)

##***REMOVED***1. Render.com 가입
https://render.com

##***REMOVED***2. New Web Service 생성
...
#***REMOVED***🚀 Vercel 배포 (올인원, 추천)

##***REMOVED***1. 프로젝트 구조 변경
```
/
├── frontend-poc/ (정적 파일)
│   ├── index.html
...
##***REMOVED***2. api/request-voucher.js 생성
```javascript
...
##***REMOVED***방법 1: Cloudflare Pages + Render.com ⭐
- **프론트엔드**: Cloudflare Pages (빠름)
- **백엔드**: Render.com (무료)
- **장점**: 각자 전문 분야, 무료
- **단점**: 2개 서비스 관리

##***REMOVED***방법 2: Vercel 올인원 💡
- **프론트엔드 + 백엔드**: Vercel
- **장점**: 단일 서비스, 간단함
...
##***REMOVED***Cloudflare Pages 환경 변수 설정
```
Settings → Environment Variables → Add variable
GAME_WALLET_PRIVATE_KEY=your_mnemonic
```

##***REMOVED***Render.com 환경 변수 설정
```
