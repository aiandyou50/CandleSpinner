...
#***REMOVED***🎯 배포 스크립트 업데이트

##***REMOVED***변경 사항

###***REMOVED***1. 배포자 정보 자동 로드
**이전**:
```typescript
...
#***REMOVED***🔧 환경 확인 스크립트 (신규)

##***REMOVED***새 스크립트 추가: `scripts/checkEnv.ts`
...
***REMOVED***또는 메인넷 배포 (실제 비용 발생)
npm run deploy -- --mainnet
```

##***REMOVED***Step 4: Tonkeeper에서 QR 코드 승인
```
...
##***REMOVED***1. 컨트랙트 주소 저장
배포 완료 후 출력된 주소:
```bash
📍 컨트랙트 주소: EQA...

***REMOVED***이 주소를 wrangler.toml에 저장:
[env.production]
WITHDRAWAL_MANAGER = "EQA..."
```

##***REMOVED***2. 컨트랙트 검증 (tonscan.org)
```
...
##***REMOVED***문제 1: "DEPLOYER_PRIVATE_KEY not found"
```bash
***REMOVED***해결: .env.local 파일 확인
