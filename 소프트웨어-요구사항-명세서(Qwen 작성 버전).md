...
#***REMOVED***⚙️ 5. 빌드 설정 (`vite.config.js`)
...
#***REMOVED***🌐 6. TON Connect 매니페스트 (`public/tonconnect-manifest.json`)
...
#***REMOVED***🧠 8. 핵심 구현 (`src/components/app-root.ts`)
...
#***REMOVED***✅ 10. 검증 체크리스트 (구현 후 반드시 확인)
