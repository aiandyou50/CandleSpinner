***REMOVED***🎯 CSPIN 인출 시스템 PoC 완전 가이드
...
##***REMOVED***Step 2: 프론트엔드 실행

```bash
***REMOVED***간단한 HTTP 서버 실행
cd frontend-poc
...
###***REMOVED***3-2. Claimable 금액 설정 (관리자)
